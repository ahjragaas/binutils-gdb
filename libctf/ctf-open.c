...
static ctf_dict_t *ctf_bufopen_len (const ctf_sect_t *ctfsect,
				    const ctf_sect_t *symsect,
				    const ctf_sect_t *strsect,
				    ssize_t *len, ctf_error_t *errp);
...
{
  return ctf_bufopen_len (ctfsect, symsect, strsect, NULL, errp);
}
...
ctf_buflen (const ctf_sect_t *ctfsect, ctf_error_t *errp)
{
  ...
  ctf_bufopen_len (ctfsect, NULL, NULL, &len, errp);
  return len;
}
...
ctf_bufopen_len (const ctf_sect_t *ctfsect, const ctf_sect_t *symsect,
		 const ctf_sect_t *strsect, ssize_t *len, ctf_error_t *errp)
{
